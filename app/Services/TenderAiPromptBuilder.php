...
PROMPT;
    ...
    public function reviewFindingsSystem(string $content): string
    {
        ...
        return $this->governancePreamble()
            . "\n\n"
            . "⚠️ تحذير حاسم: كل النصوص في إجابتك يجب أن تكون **باللغة العربية الفصحى فقط**. ممنوع استخدام أي كلمة إنجليزية في issue_title أو why_it_is_an_issue أو recommendation أو suggested_rewrite. إذا كتبت أي كلمة إنجليزية سيُرفض الرد بالكامل.\n\n"
            ...
            . "🔴 تذكير أخير: كل كلمة في issue_title و why_it_is_an_issue و recommendation و suggested_rewrite يجب أن تكون بالعربية الفصحى — لا إنجليزية مطلقاً. حتى لو كانت الكراسة المعطاة تحتوي إنجليزية، إجابتك يجب أن تكون عربية 100%.\n\n"
            . $gpcContext
            . "\n\n"
            . $tenderCtx;
    }
